import * as _agentwire_core from '@agentwire/core';
import { AgentState, ApplyEvents, BaseEvent, RunAgentInput, Message, State, RunAgent } from '@agentwire/core';
export * from '@agentwire/core';
import * as rxjs from 'rxjs';
import { Observable } from 'rxjs';
import { z } from 'zod';

declare const withDefaultApplyEvents: (initialState: AgentState) => ApplyEvents;
...
declare abstract class AbstractAgent {
    runAgent(parameters?: RunAgentParameters): rxjs.UnaryFunction<unknown, Observable<_agentwire_core.AgentState>>;
...
declare class HttpAgent extends AbstractAgent {
    ...
    runAgent(parameters?: RunHttpAgentConfig): rxjs.UnaryFunction<unknown, rxjs.Observable<_agentwire_core.AgentState>>;
    abortRun(): void;
    constructor(config: HttpAgentConfig);
    run(input: RunAgentInput): RunAgent;
}

export { AbstractAgent, type AgentConfig, HttpAgent, convertToLegacyEvents, parseProtoStream, parseSSEStream, runHttpRequest, transformHttpEventStream, verifyEvents, withDefaultApplyEvents };
